...
def quote_attrib(inStr):
    s1 = (isinstance(inStr, unicode) and inStr or
          '%s' % inStr)
    s1 = s1.replace('&', '&amp;')
    s1 = s1.replace('<', '&lt;')
    s1 = s1.replace('>', '&gt;')
...
class map(SBGNBase):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='sbgn:', name_='map'):
        ...
        if self.language is not None and 'language' not in already_processed:
            ...
            outfile.write(' language=%s' % (self.gds_format_string(quote_attrib(self.language), input_name='language'), ))#.encode(ExternalEncoding), input_name='language'), ))
...
class glyph(SBGNBase):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='sbgn:', name_='glyph'):
        ...
        if self.compartmentRef is not None and 'compartmentRef' not in already_processed:
            ...
            outfile.write(' compartmentRef=%s' % (self.gds_format_string(quote_attrib(self.compartmentRef), input_name='compartmentRef'), ))
        if self.class_ is not None and 'class_' not in already_processed:
            already_processed.add('class_')
            outfile.write(' class=%s' % (self.gds_format_string(quote_attrib(self.class_), input_name='class'), ))
        ...
        if self.orientation is not None and 'orientation' not in already_processed:
            ...
            outfile.write(' orientation=%s' % (self.gds_format_string(quote_attrib(self.orientation), input_name='orientation'), ))
...
class arc(SBGNBase):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='sbgn:', name_='arc'):
        ...
        if self.source is not None and 'source' not in already_processed:
            ...
            outfile.write(' source=%s' % (self.gds_format_string(quote_attrib(self.source), input_name='source'), ))
...
class stateType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='sbgn:', name_='stateType'):
        if self.variable is not None and 'variable' not in already_processed:
            ...
            outfile.write(' variable=%s' % (self.gds_format_string(quote_attrib(self.variable), input_name='variable'), ))
